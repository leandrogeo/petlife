...
@Component({
  selector: 'app-modificarvacuna',
  templateUrl: './modificarvacuna.component.html',
  styleUrls: ['./modificarvacuna.component.scss'],
})
export class ModificarvacunaComponent implements OnInit {
  id_cita: string 
      ...
      if (this.vacunacion.proxi_vac != '') {
        if (this.vacunacion.peso_vac != '') {
          if (this.vacunacion.vacunas != '') {
            ...
            this.presentLoading();
            const path = 'Usuarios/' + this.citas.idtutor_cita + '/Mascotas/' + this.citas.id_mascotacita + '/Vacunacion';
